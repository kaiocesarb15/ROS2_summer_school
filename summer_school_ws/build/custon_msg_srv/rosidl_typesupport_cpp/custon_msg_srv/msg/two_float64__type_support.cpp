...
static const _TwoFloat64_type_support_symbol_names_t _TwoFloat64_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custon_msg_srv, msg, TwoFloat64)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custon_msg_srv, msg, TwoFloat64)),
  }
};
...
{
  return &::custon_msg_srv::msg::rosidl_typesupport_cpp::TwoFloat64_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custon_msg_srv, msg, TwoFloat64)() {
  return get_message_type_support_handle<custon_msg_srv::msg::TwoFloat64>();
}
