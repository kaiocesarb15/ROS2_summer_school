...
#include "custon_msg_srv/msg/detail/two_float64__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custon_msg_srv::msg::TwoFloat64;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custon_msg_srv::msg::TwoFloat64 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custon_msg_srv::msg::TwoFloat64 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TwoFloat64__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custon_msg_srv::msg::TwoFloat64 *>(
...
static size_t _TwoFloat64__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TwoFloat64(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TwoFloat64__callbacks = {
  "custon_msg_srv::msg",
  "TwoFloat64",
...
static rosidl_message_type_support_t _TwoFloat64__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TwoFloat64__callbacks,
...
{
  return &custon_msg_srv::msg::typesupport_fastrtps_cpp::_TwoFloat64__handle;
}
